...
V naší implementaci v jazyce expl3 ze sekce~\ref{sec:implementace} by pro podobnou změnu stačilo upravit existující řádky 71--77. Vestavěná funkce \verb"\str_uppercase:f" jazyka expl3 pro kapitalizaci prvního písmene navíc podporuje znaky s diakritikou, zatímco \TeX ový primitiv \verb"\uppercase" umí pracovat jen s 52 písmeny znakové sady \acro{ASCII}.
